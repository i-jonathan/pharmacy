<template>
    <div class="overflow-y-auto max-h-[900px] rounded-lg shadow">
        <table
            class="w-full min-w-[900px] bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700 table-fixed"
        >
