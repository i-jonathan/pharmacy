<template>
    <div>
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-xl font-bold text-neutral-800 dark:text-neutral-100">Permission Management</h2>
            <button
        ...
        <div v-else-if="permissions.length === 0" class="text-center py-12 text-neutral-500 dark:text-neutral-400">
        ...
        <div v-else class="bg-white dark:bg-neutral-800 rounded-xl shadow overflow-hidden border border-neutral-200 dark:border-neutral-700">
            <table class="w-full text-sm text-left">
                ...
                <tbody class="divide-y divide-neutral-100 dark:divide-neutral-700">
                    <tr v-for="perm in permissions" :key="perm.id" class="hover:bg-neutral-50 dark:hover:bg-neutral-700/40">
                        <td class="px-6 py-4 font-medium text-neutral-900 dark:text-neutral-100">{{ perm.resource }}</td>
                        <td class="px-6 py-4 text-neutral-600 dark:text-neutral-300">{{ perm.action }}</td>
                        <td class="px-6 py-4">
                            <div class="flex flex-wrap gap-1 items-center">
                                ...
                                <button
                                    ...
                                    class="inline-flex items-center px-2 py-0.5 text-xs rounded-full border border-dashed border-neutral-300 dark:border-neutral-600 text-neutral-500 dark:text-neutral-400 hover:border-emerald-400 hover:text-emerald-600 transition-colors"
                                >+ Assign</button>
                            </div>
                        </td>
        ...
        <div v-if="showCreateModal" class="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div class="relative bg-white dark:bg-neutral-800 rounded-xl shadow-xl p-6 w-full max-w-md mx-4">
                <h3 class="text-lg font-semibold text-neutral-800 dark:text-neutral-100 mb-4">Add Permission</h3>
                <form @submit.prevent="createPermission">
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1">Resource</label>
                        <input
                            v-model="newResource"
                            type="text"
                            required
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1">Action</label>
                        <input
                            v-model="newAction"
                            type="text"
                            required
            ...
            <div class="relative bg-white dark:bg-neutral-800 rounded-xl shadow-xl p-6 w-full max-w-sm mx-4">
                ...
                <div class="space-y-2 mb-4">
                    <button
                        ...
                        class="w-full text-left px-4 py-2 rounded-lg hover:bg-emerald-50 dark:hover:bg-emerald-900/30 text-neutral-700 dark:text-neutral-200 hover:text-emerald-700 dark:hover:text-emerald-300 transition-colors"
                    >{{ role.name }}</button>
                </div>
                <div class="text-right">
                    <button
                        @click="assigningPerm = null"
                        class="px-4 py-2 text-sm text-neutral-500 hover:text-neutral-700 transition-colors"
                    >Cancel</button>
                </div>
            </div>
        </div>
        ...
        <div v-if="deletingPerm" class="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div class="relative bg-white dark:bg-neutral-800 rounded-xl shadow-xl p-6 w-full max-w-sm mx-4">
                <h3 class="text-lg font-semibold text-neutral-800 dark:text-neutral-100 mb-2">Delete Permission</h3>
